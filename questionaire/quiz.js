...
const startbtn5 = document.querySelector(".start"),
...
startbtn5.addEventListener("click", startQuiz);
...
const loadingAnimation = () => {
  startbtn5.innerHTML = "Loading";
  const loadingInterval = setInterval(() => {
    if (startbtn5.innerHTML.length === 10) {
      startbtn5.innerHTML = "Loading";
    } else {
      startbtn5.innerHTML += ".";
    }
...
const submitbtn5 = document.querySelector(".submit"),
  nextbtn5 = document.querySelector(".next");
...
const restartbtn5 = document.querySelector(".restart");
